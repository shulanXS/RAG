...
from backend.domain.retrieval.fusion import DynamicRRFFusion, DEFAULT_K_BY_COMPLEXITY, FusionResult
from backend.domain.retrieval.reranker import CrossEncoderReranker, get_reranker
...
class HybridSearchEngine:
    ...
    def from_config(cls, config, embedder: Embedder) -> "HybridSearchEngine":
        ...
        if config.reranker.provider == "cohere":
            from backend.domain.retrieval.reranker import CohereReranker
            reranker = CohereReranker(model=config.reranker.cohere_model)
        elif config.reranker.provider == "bge":
            from backend.domain.retrieval.reranker import BGEReranker
    ...
    async def search(
        ...
        from backend.domain.tenant import build_tenant_filter
